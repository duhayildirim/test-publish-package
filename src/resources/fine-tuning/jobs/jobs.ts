...
export class Jobs extends APIResource {
   ...
   *
   * [Learn more about fine-tuning](https://platform.hyperbee.com/docs/guides/fine-tuning)
   */
...
export interface FineTuningJob {
   ...
   * [fine-tuning guide](https://platform.hyperbee.com/docs/guides/fine-tuning) for
   * more details.
   */
   ...
   * results with the
   * [Files API](https://platform.hyperbee.com/docs/api-reference/files/retrieve-contents).
   */
...
export interface FineTuningJobWandbIntegration {
   ...
   * through directly to WandB. Some default tags are generated by hyperbee:
   * "hyperbee/finetune", "hyperbee/{base-model}", "hyperbee/{ftjob-abcdef}".
   */
  tags?: Array<string>;
}
...
export interface JobCreateParams {
   ...
   * [supported models](https://platform.hyperbee.com/docs/guides/fine-tuning/which-models-can-be-fine-tuned).
   */
   ...
   *
   * See [upload file](https://platform.hyperbee.com/docs/api-reference/files/create)
   ...
   * [chat](https://platform.hyperbee.com/docs/api-reference/fine-tuning/chat-input) or
   * [completions](https://platform.hyperbee.com/docs/api-reference/fine-tuning/completions-input)
   * format.
   *
   * See the [fine-tuning guide](https://platform.hyperbee.com/docs/guides/fine-tuning)
   * for more details.
   */
  training_file: string;
   ...
   * `ft:gpt-4o-mini:hyperbee:custom-model-name:7p4lURel`.
   */
  suffix?: string | null;

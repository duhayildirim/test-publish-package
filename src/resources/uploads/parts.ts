...
export class Parts extends APIResource {
  /**
   * Adds a
   * [Part](https://platform.hyperbee.com/docs/api-reference/uploads/part-object) to an
   ...
   * [complete the Upload](https://platform.hyperbee.com/docs/api-reference/uploads/complete).
   */
  create(
    uploadId: string,

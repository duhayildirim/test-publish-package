...
export class Files extends APIResource {
   ...
   * [File](https://platform.hyperbee.com/docs/api-reference/files) to a
   ...
   * [delete file](https://platform.hyperbee.com/docs/api-reference/files/delete)
   * endpoint.
   */
  del(
    vectorStoreId: string,
      ...
      switch (file.status) {
        case 'in_progress':
          ...
          if (options?.pollIntervalMs) {
            ...
            const headerInterval = fileResponse.response.headers.get('hyperbee-poll-after-ms');
            if (headerInterval) {
...
export interface FileCreateParams {
  /**
   * A [File](https://platform.hyperbee.com/docs/api-reference/files) ID that the

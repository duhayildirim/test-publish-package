...
export namespace CodeInterpreterOutputImage {
  export interface Image {
    /**
     * The [file](https://platform.hyperbee.com/docs/api-reference/files) ID of the
     * image.
     */
    file_id?: string;
  }
...
export namespace FunctionToolCall {
  ...
  export interface Function {
     ...
     * [submitted](https://platform.hyperbee.com/docs/api-reference/runs/submitToolOutputs)
     * yet.
     */
    output: string | null;
  }
...
export interface RunStep {
  ...
  /**
   * The ID of the
   * [assistant](https://platform.hyperbee.com/docs/api-reference/assistants)
  ...
  /**
   * The ID of the [run](https://platform.hyperbee.com/docs/api-reference/runs) that

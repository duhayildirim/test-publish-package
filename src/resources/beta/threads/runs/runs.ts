...
export class Runs extends APIResource {
   ...
   * https://platform.hyperbee.com/docs/assistants/how-it-works/runs-and-run-steps
   */
  async createAndPoll(
    threadId: string,
...
export interface RequiredActionFunctionToolCall {
   ...
   * [Submit tool outputs to run](https://platform.hyperbee.com/docs/api-reference/runs/submitToolOutputs)
   * endpoint.
   */
  id: string;
...
export interface Run {
  ...
  /**
   * The ID of the
   * [assistant](https://platform.hyperbee.com/docs/api-reference/assistants) used for
  ...
  /**
   * Whether to enable
   * [parallel function calling](https://platform.hyperbee.com/docs/guides/function-calling/parallel-function-calling)
   * during tool use.
   */
  ...
  /**
   * The ID of the [thread](https://platform.hyperbee.com/docs/api-reference/threads)
...
export interface RunCreateParamsBase {
  /**
   * The ID of the
   * [assistant](https://platform.hyperbee.com/docs/api-reference/assistants) to use to
   * execute this run.
   */
  assistant_id: string;
  ...
  /**
   * Overrides the
   * [instructions](https://platform.hyperbee.com/docs/api-reference/assistants/createAssistant)
  ...
  /**
   * The ID of the [Model](https://platform.hyperbee.com/docs/api-reference/models) to

...
export interface ImageFile {
  /**
   * The [File](https://platform.hyperbee.com/docs/api-reference/files) ID of the image
...
/**
 * References an image [File](https://platform.hyperbee.com/docs/api-reference/files)
...
export interface Message {
   ...
   * [assistant](https://platform.hyperbee.com/docs/api-reference/assistants) that
  ...
  /**
   * The ID of the [run](https://platform.hyperbee.com/docs/api-reference/runs)
  ...
  /**
   * The [thread](https://platform.hyperbee.com/docs/api-reference/threads) ID that

...
export interface Assistant {
   ...
   * [List models](https://platform.hyperbee.com/docs/api-reference/models/list) API to
   * see all of your available models, or see our
   * [Model overview](https://platform.hyperbee.com/docs/models/overview) for
   ...
   * [GPT-4o](https://platform.hyperbee.com/docs/models/gpt-4o),
   * [GPT-4 Turbo](https://platform.hyperbee.com/docs/models/gpt-4-turbo-and-gpt-4),
   * and all GPT-3.5 Turbo models since `gpt-3.5-turbo-1106`.
   *
   * Setting to `{ "type": "json_schema", "json_schema": {...} }` enables Structured
   * Outputs which guarantees the model will match your supplied JSON schema. Learn
   * more in the
   * [Structured Outputs guide](https://platform.hyperbee.com/docs/guides/structured-outputs).
   *
...
export namespace Assistant {
  ...
  export namespace ToolResources {
    export interface CodeInterpreter {
      /**
       * A list of [file](https://platform.hyperbee.com/docs/api-reference/files) IDs made
 ...
 * [Assistants API quickstart](https://platform.hyperbee.com/docs/assistants/overview)
...
export namespace AssistantStreamEvent {
  /**
   * Occurs when a new
   * [thread](https://platform.hyperbee.com/docs/api-reference/threads/object) is
   * created.
   */
  export interface ThreadCreated {
    /**
     * Represents a thread that contains
     * [messages](https://platform.hyperbee.com/docs/api-reference/messages).
     */
  ...
  /**
   * Occurs when a new
   * [run](https://platform.hyperbee.com/docs/api-reference/runs/object) is created.
   */
  export interface ThreadRunCreated {
    /**
     * Represents an execution run on a
     * [thread](https://platform.hyperbee.com/docs/api-reference/threads).
     */
    data: RunsAPI.Run;
  ...
  /**
   * Occurs when a [run](https://platform.hyperbee.com/docs/api-reference/runs/object)
  ...
  /**
   * Occurs when a
   * [run step](https://platform.hyperbee.com/docs/api-reference/runs/step-object) is
   * created.
   */
  ...
  /**
   * Occurs when a
   * [run step](https://platform.hyperbee.com/docs/api-reference/runs/step-object)
   ...
   * [run step](https://platform.hyperbee.com/docs/api-reference/runs/step-object) are
   * being streamed.
   */
  ...
  /**
   * Occurs when a
   * [message](https://platform.hyperbee.com/docs/api-reference/messages/object) is
   * created.
   */
  ...
  /**
   * Occurs when a
   * [message](https://platform.hyperbee.com/docs/api-reference/messages/object) moves
  ...
  /**
   * Occurs when parts of a
   * [Message](https://platform.hyperbee.com/docs/api-reference/messages/object) are
   * being streamed.
   */
  ...
  /**
   * Occurs when a
   * [message](https://platform.hyperbee.com/docs/api-reference/messages/object) ends
  ...
  /**
   * Occurs when an
   * [error](https://platform.hyperbee.com/docs/guides/error-codes/api-errors) occurs.
...
export namespace FileSearchTool {
  ...
  export interface FileSearch {
     ...
     * See the
     * [file search tool documentation](https://platform.hyperbee.com/docs/assistants/tools/file-search/number-of-chunks-returned)
  ...
  export namespace ToolResources {
    ...
    export namespace FileSearch {
      export interface VectorStore {
        ...
        /**
         * A list of [file](https://platform.hyperbee.com/docs/api-reference/files) IDs to
...
export namespace AssistantUpdateParams {
  ...
  export namespace ToolResources {
    export interface CodeInterpreter {
       ...
       * [file](https://platform.hyperbee.com/docs/api-reference/files) IDs made available

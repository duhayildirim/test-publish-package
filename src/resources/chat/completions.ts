...
export namespace ChatCompletionContentPartImage {
  export interface ImageURL {
     ...
     * [Vision guide](https://platform.hyperbee.com/docs/guides/vision/low-or-high-fidelity-image-understanding).
     */
...
export interface ChatCompletionCreateParamsBase {
   ...
   * [Example Python code](https://cookbook.hyperbee.com/examples/how_to_format_inputs_to_chatgpt_models).
   */
  messages: Array<ChatCompletionMessageParam>;

  /**
   * ID of the model to use. See the
   * [model endpoint compatibility](https://platform.hyperbee.com/docs/models/model-endpoint-compatibility)
   ...
   * [GPT-4o mini](https://platform.hyperbee.com/docs/models/gpt-4o-mini),
   * [GPT-4 Turbo](https://platform.hyperbee.com/docs/models/gpt-4-and-gpt-4-turbo) and

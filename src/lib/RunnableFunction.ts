...
export type RunnableFunctionWithParse<Args extends object> = {
   ...
   * @returns a string to send back to hyperbee.
   */
  function: (
    args: Args,
  ...
  /**
   * @param input the raw args from the hyperbee function call.
...
export type RunnableFunctionWithoutParse = {
  /**
   * @param args the raw args from the hyperbee function call.
   * @returns a string to send back to hyperbee
   */
  function: (
    args: string,
